...
- [x] 7. Intel 530 SSD 위에 Proxmox Native LXC 컨테이너 순차 구축 완료:
  ...
  - [x] 7-5. `LXC 107 (Homepage + Uptime Kuma + MeTube)` 구축 (4단 대칭 포털 & 24H 장애 관제 & YouTube 4K/음원 한글 추출)
  - [x] 7-6. `LXC 109 (Full *Arr Media Stack)` 구축 (Jellyseerr + Radarr + Sonarr + Prowlarr + FlareSolverr + qBit 완전 무인 자동화)
