...
2. **환경 변수 수정**
   - `VUE_APP_API_URL`: `http://YOUR_SERVER_IP:8080` 또는 상대 경로
   - `VUE_APP_KOTLIN_API_URL`: `http://YOUR_SERVER_IP:8081` 또는 상대 경로
...
VUE_APP_API_URL=http://YOUR_SERVER_IP:8080
VUE_APP_KOTLIN_API_URL=http://YOUR_SERVER_IP:8081
```
...
#### 6.2 헬스 체크
- [ ] Spring Boot API: `http://YOUR_SERVER_IP:3000/api/springboot/health`
- [ ] Kotlin API: `http://YOUR_SERVER_IP:3000/api/kotlin/health`
