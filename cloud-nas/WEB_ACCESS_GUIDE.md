...
| 서비스 | 포트 | 접속 URL | 용도 | 상태 |
|--------|------|----------|------|------|
| **Portainer** | 9000, 9443 | http://YOUR_SERVER_IP:9000 | Docker 관리 | ✅ 실행 중 |
| **Netdata Cloud** | - | https://app.netdata.cloud | 시스템 모니터링 (권장) | ✅ 연동 완료 |
| **Netdata 로컬** | 19999 | http://YOUR_SERVER_IP:19999 | 시스템 모니터링 | ✅ 실행 중 |
| **Plane** | 80 | http://YOUR_SERVER_IP | 프로젝트 관리 | ✅ 실행 중 |
| **Frontend (Vue)** | 3000 | http://YOUR_SERVER_IP:3000 | NAS 애플리케이션 | ✅ 실행 중 |
| **MySQL** | 3306 | YOUR_SERVER_IP:3306 | 데이터베이스 | ✅ 실행 중 |
...
- HTTPS: https://YOUR_SERVER_IP:9443 (권장)
...
**예시:**
```
http://YOUR_SERVER_IP:3000/api/springboot/health
http://YOUR_SERVER_IP:3000/api/kotlin/health
```
...
```bash
# 로컬에서 실행
ssh -L 3306:localhost:3306 -i ~/.ssh/oci-nas-key ubuntu@YOUR_SERVER_IP
...
**관리 도구:**
- [Portainer](http://YOUR_SERVER_IP:9000) - Docker 관리
- [Netdata Cloud](https://app.netdata.cloud) - 시스템 모니터링 (권장, 동적 IP 지원)
- [Netdata 로컬](http://YOUR_SERVER_IP:19999) - 시스템 모니터링 (로컬)

**프로젝트 관리:**
- [Plane](http://YOUR_SERVER_IP) - 이슈 트래킹, Sprint, 칸반, 배포 관리

**애플리케이션:**
- [NAS Frontend](http://YOUR_SERVER_IP:3000) - 메인 애플리케이션

**API 헬스 체크:**
- [Spring Boot Health](http://YOUR_SERVER_IP:3000/api/springboot/health)
- [Kotlin Health](http://YOUR_SERVER_IP:3000/api/kotlin/health)
...
**작성일:** 2026-01-31
**서버:** OCI Ubuntu 22.04 ARM64 (YOUR_SERVER_IP)
