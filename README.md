...
### 모니터링 도구 (Docker Compose로 관리)

- **Netdata** (포트 19999): 실시간 모니터링 및 시각화 (Docker)
  - 시스템 메트릭 (CPU, RAM, 디스크, 네트워크)
  - Docker 컨테이너 메트릭
  - 애플리케이션 메트릭
  - 실시간 대시보드 및 알림
  - **리소스**: 약 200-400MB RAM (경량)
...
- Oracle Cloud Security Group 설정 (포트 22, 80, 443, 3000, 9000, 19999)
