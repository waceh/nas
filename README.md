...
상세 구축 과정 및 세부 설정 가이드는 [`self-nas/docs/00_progress_and_handover_notes.md`](self-nas/docs/00_progress_and_handover_notes.md)(⭐진행현황/인수인계), [`self-nas/docs/10_graceful_power_management_and_jellyfin_guide.md`](self-nas/docs/10_graceful_power_management_and_jellyfin_guide.md), [`self-nas/docs/09_immich_caddy_https_and_storage_setup.md`](self-nas/docs/09_immich_caddy_https_and_storage_setup.md), [`self-nas/docs/08_storage_tiering_and_media_separation.md`](self-nas/docs/08_storage_tiering_and_media_separation.md), [`self-nas/README.md`](self-nas/README.md), [`self-nas/POST_PROXMOX_SETUP_GUIDE.md`](self-nas/POST_PROXMOX_SETUP_GUIDE.md), [참고/검토: 확장 서비스 후보군](self-nas/docs/98_candidate_services_and_architecture_review.md) 및 [번외편: KMP 모바일 앱 아키텍처](self-nas/docs/99_kmp_gonic_mobile_app_architecture.md)를 참고하세요.
